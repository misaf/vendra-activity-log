...
- Add or update focused Pest coverage, then run `composer --working-dir=packages/vendra-activity-log test` and `composer --working-dir=packages/vendra-activity-log analyse`.
