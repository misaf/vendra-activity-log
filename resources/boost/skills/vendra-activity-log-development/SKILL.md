...
Treat `app-modules/vendra-activity-log` as the source of activity-log domain behavior and Filament admin UI.
...
- Run module checks from the package when possible: `composer --working-dir=app-modules/vendra-activity-log test` and `composer --working-dir=app-modules/vendra-activity-log analyse`.
